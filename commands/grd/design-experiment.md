---
name: grd:design-experiment
description: Create detailed execution plan for an experiment (PLAN.md) with verification loop
...
IMPORTANT: If phase context exists below, it contains USER DECISIONS from /grd:discuss-phase.
