...
Ensure all existing placeholders from grd-explorer.md are preserved.
  ...
  <verify>
Read templates/data-report.md and confirm:
1. ## Hardware Profile section exists
2. {{hardware_profile_section}} placeholder present
3. {{hardware_timestamp}} placeholder present
4. Section is positioned after Data Overview
  </verify>
  <done>
