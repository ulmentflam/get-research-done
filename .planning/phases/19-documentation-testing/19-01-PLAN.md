...
Output a formatted report for human review.
  ...
  <verify>Report includes all stale references with context. Expected matches:
- agents/grd-planner.md: lines 115, 1198 (plan-phase, add-phase, insert-phase)
- agents/grd-executor.md: line 3 (execute-phase)
- agents/grd-roadmapper.md: line 185 (insert-phase)
- agents/grd-debugger.md: line 1179 (plan-phase)
- get-research-done/workflows/list-phase-assumptions.md: line 4 (discuss-phase)
- get-research-done/workflows/verify-work.md: line 2 (plan-phase)
- GRD-STYLE.md: lines 167, 184 (execute-phase)</verify>
