...
**Pre-requisites:**
1. Create `tests/integration/` directory structure if it doesn't exist
2. Verify package.json engines.node is >= 18.0.0 (required for node:test). If it specifies a lower version (e.g., >=16.7.0), update it to >=18.0.0
