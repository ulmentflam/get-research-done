...
- This section feeds directly into /grd:design-experiment --gaps
...
5. status → "diagnosed"
6. Ready for /grd:design-experiment --gaps with root causes
...
**Creation:** When /grd:validate-results starts new session
