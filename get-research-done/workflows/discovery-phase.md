...
Called from design-experiment.md's mandatory_discovery step with a depth parameter.

NOTE: For comprehensive ecosystem research ("how do experts build this"), use /grd:literature-review instead, which produces RESEARCH.md.
</purpose>
...
**Depth is determined by design-experiment.md before routing here.**
</depth_levels>
...
Check the depth parameter passed from design-experiment.md:
...
4. **If verified:** Return to design-experiment.md with confirmation. No DISCOVERY.md needed.
...
7. Return to design-experiment.md.

**Output:** `.planning/experiments/XX-name/DISCOVERY.md`
</step>
...
8. Return to design-experiment.md.

**Output:** `.planning/experiments/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Write `.planning/experiments/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .planning/experiments/XX-name/DISCOVERY.md
