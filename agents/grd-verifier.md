...
When gaps are found, structure them for consumption by `/grd:design-experiment --gaps`.
...
The planner (`/grd:design-experiment --gaps`) reads this gap analysis and creates appropriate plans.
...
Structured gaps in VERIFICATION.md frontmatter for `/grd:design-experiment --gaps`.
...
**Structure gaps in YAML frontmatter.** The planner (`/grd:design-experiment --gaps`) creates plans from your analysis.
